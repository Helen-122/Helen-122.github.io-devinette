...
function testing() {
    ...
    if (isNaN(inputValue) == false && inputValue > 0 && inputValue < 101 && i < 7) {
        ...
        if (inputValue < mysteryNumber) {
            rightOrFalse.textContent = "Ce n'est pas le nombre mystère, essayez encore!";
            rightOrFalse.style.color = "#fffae5";
            rightOrFalse.style.fontFamily = "Roboto, sans serif";
            rightOrFalse.style.fontSize = "large";
            hint.textContent = 'Indice : Le nombre saisi est trop petit';
            hint.style.color = "#CBA36D";
        }
            ...
            rightOrFalse.textContent = `Félicitations! Vous avez trouvé en ${i} coups!`;
            rightOrFalse.style.color = "#fffae5";
            rightOrFalse.style.fontFamily = "Times, sans serif";
        ...
        //condition imbriquée
        if (i > 6) {
            rightOrFalse.textContent = "Perdu... La soluton était " + mysteryNumber + "";
            rightOrFalse.style.color = "#fffae5";
            rightOrFalse.style.fontFamily = "Times, sans serif";
            rightOrFalse.style.fontSize = "x-large";
            setGameOver();
            ...
            rightOrFalse.textContent = "Votre nombre doit être entre 1 et 100";
            rightOrFalse.style.color = "#CBA36D";
            rightOrFalse.style.fontSize = "large";
            hint.textContent = ' ';
        }
    }
...
function setGameOver() {
    ...
    resetButton.classList.add("Rejouer", "btn");
    resetButton.textContent = "Rejouer";
    resetButton.style.color = "#CBA36D";
    resetButton.style.borderRadius = "20px";
    resetButton.style.border = "solid 2px #CBA36D";
